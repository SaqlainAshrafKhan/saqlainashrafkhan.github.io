  ...
  return (
    <div className="min-h-screen bg-paper text-zinc-950 antialiased dark:bg-ink dark:text-white">
      ...
      <main>
        ...
        <Section id="products" eyebrow="Featured Products" title="Product work shaped around real business problems." description="A selection of products built around business workflows, user experience, architecture, and practical delivery.">
